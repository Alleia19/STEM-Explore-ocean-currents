/*
 * Electroconductivity Meter code for use with the Oceans: How Currents Work lesson plan 
 ...
 * 
 * The EC Meter raw ADC readings are converted to Volts (4 decimal points: 0.0000) and sent directly to Excel. 
 * 
 * 2018 Microsoft EDU Workshop
 * 
 */
